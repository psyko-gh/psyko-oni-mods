        ...
        public class BUILDINGS
        {
            public class PREFABS
            {
                public class FREEZER
                {
                    ...
                    public static LocString EFFECT = "Stores " + FormatAsLink("Food", "FOOD") + " at a very cold " +
                                                     FormatAsLink("Temperature", "HEAT") + " to stop spoilage.";

                    public static LocString LOGIC_PORT = "Full/Not Full";

                    public static LocString LOGIC_PORT_ACTIVE = "Sends a " +
                                                                FormatAsAutomationState("Green Signal",
                                                                    AutomationState.Active) + " when full";

                    public static LocString LOGIC_PORT_INACTIVE = "Otherwise, sends a " +
                                                                  FormatAsAutomationState("Red Signal",
            ...
            public static class STATUSITEMS
            {
                public static class FRIDGECOOLING
                {
                    ...
                    public static LocString TOOLTIP =
                        (LocString)
                        "{UsedPower} of {MaxPower} are being used to cool the contents of this food storage";
                }
